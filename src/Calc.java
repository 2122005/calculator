...
public static String parse(String expression) throws Exception {
        ...
        //Конвертируем числа в арабские для вычисления
        ...
        if (isRoman) {
            ...
            //Конвертируем результат операции из арабского в римское число
   ...
   class Roman {
    static String[] romanArray = new String[]{"0", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X",
            ...
            "XXXVII", "XXXVIII", "XXIX", "XL", "XLI","XLII", "XLIII", "XXLIV", "XLV", "XLVI", "XLVII", "XLVIII",
